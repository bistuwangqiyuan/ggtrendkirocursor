...
- **Recency-First Reports**: `/bp` defaults to business opportunities from the **last month**, with a window selector (7d / 30d / 90d / 1y / all) so recent, actionable plans are not buried under the full archive.
